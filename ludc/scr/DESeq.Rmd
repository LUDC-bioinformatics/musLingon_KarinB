...
# order by padj
all3res <- all3res[order(all3res$padj_HFD_vs_Lingon,
...
[heatmap for all DE genes](results/figures/heatmap_for_all_DE_genes.pdf)

[heatmap for DE genes between HFD_vs_Lingon](results/figures/heatmap_for_DE_genes_between_HFD_vs_Lingon.pdf)
